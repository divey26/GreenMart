...
const DeliveryPersonManagementPage = () => {
  ...
  const fetchDeliveryPersons = async () => {
    try {
      const response = await axios.get("http://localhost:8020/api/delivery-person/get");
  ...
  const deleteItem = async (id) => {
    try {
      const response = await axios.delete(`http://localhost:8020/api/delivery-person/delete/${id}`, {
        headers: {
          Authorization: token,
        },
      });
    ...
    try {
      ...
      if (editingDeliveryPerson) {
        response = await axios.put(
          "http://localhost:8020/api/delivery-person/update",
        ...
        response = await axios.post(
          "http://localhost:8020/api/delivery-person/create",
          values,
          {
            headers: {
              Authorization: token,
