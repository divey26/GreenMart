...
import './package.css';
import envelope from './assets/envelope.png'; // Replace with the actual image path
import paperbag from './assets/paperbag.png'; // Replace with the actual image path
import corrugatedBox from './assets/corrugatedBox.png';
